...
#ifndef YOUTUBE_PREMIUM_SWIFT_H
#define YOUTUBE_PREMIUM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="youtube_premium",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15youtube_premium11AppDelegate")
...
SWIFT_CLASS("_TtC15youtube_premium17MainFlutterWindow")
